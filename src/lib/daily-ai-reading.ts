...
export const DAILY_AI_READING_PROMPT_VERSION = 'daily-full-memory-v7-macro-first-personal-landing';
...
- Banned drift: do not open with the user's feelings, journaling, self-care, or a general life theme unless the concrete sky mechanics have already been named.
